...
const Header = () => {
  ...
  return (
    <Navbar className="border-bottom  bg-transparent py-3 px-4 position-relative">
      <Stack direction="horizontal" className="justify-content-between w-100">
        ...
        {isBelowDesktop ? (
          ...
          <Stack direction="horizontal" gap={4} ref={ref}>
                    ...
                    options={[
                      {
                        value: (
                          <div className="w-100 d-flex justify-content-between align-items-center ">
                            ...
                            <span className="text-primary">5000/0</span>
                          </div>
                        ),
                      },
                      {
                        value: (
                          <div className="w-100 d-flex justify-content-between align-items-center ">
                            ...
                            <span className="text-primary">2500/0</span>
                          </div>
                        ),
                      },
                      {
                        value: (
                          <div className="w-100 d-flex justify-content-between align-items-center ">
                            ...
                            <span className="text-primary">15/0</span>
                          </div>
                        ),
                      },
                      {
            ...
            <CustomButton className={" px-5"} onClick={gotoMyPlan}>
              ترقية{" "}
            </CustomButton>
            <Image
              src="https://react-bootstrap-v3.netlify.app/thumbnail.png"
