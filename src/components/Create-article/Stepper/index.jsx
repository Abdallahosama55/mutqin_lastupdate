  ...
  return (
    <div className={`${styles["stepper"]}`}>
      ...
      <div className="d-flex justify-content-between  mt-2 ">
        <p className={`${styles["step-text"]} text-center`}>
          الكلمات المفتاحية
        </p>
        <p className={`${styles["step-text"]} text-center`}> العنوان</p>
        <p className={`${styles["step-text"]} text-center`}>العناوين الفرعية</p>
        <p className={`${styles["step-text"]} text-center`}>المقال</p>
      </div>
    </div>
  );
}
